...
The recorded instance rate was $0.87/hour while running. The instance reached STOPPED after testing, and Brev displayed $0.02/hour for retained storage. Stopping containers alone does not stop instance charges. Earlier Crusoe and AWS UI attempts timed out, and a Nebius L40S attempt failed on provider VPC quota. No support contact was made.
